...
1.  Back on the **Create New Project** page, click **Create Project**
    ...
    ![Azure DevOps Generator website. Clik on "Create project"](images/lab1_01.png)
...
1.  On the **Create New Project** page, click **Navigate to project**.
    ...
    ![Azure DevOps Generator website. Clik on "Navigate to Project"](images/lab1_02.png)
...
1.  In the **General** section, select the **Teams** tab. There are already a few teams in this project, but you'll create a new one for this lab. Click **New Team**.
    ...
    ![In project settings window, "Teams" tab, click on "New Team"](images/lab1_03.png)
...
1.  Repeat the previous step to add **Sprint 2** and **Sprint 3**. The second sprint is our current iteration, and the third is in the near future.
    ...
    ![Do the same for Sprint 2 and 3, make sure they are created for "PUL-Web" team](images/lab1_04.png)
